# Ada — Shizaye Multilinks Support Agent

A single-agent AI customer support application built for Shizaye Multilinks,
a multi-branch telecoms retail business in Kaduna, Nigeria. Ada answers
...
status. Ada automates first-line support, freeing staff to focus on
...
4. Conversation history persists for the session, so Ada remembers context
   within a chat.
