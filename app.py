...
st.set_page_config(page_title="Shiza — Shizaye Multilinks Support", page_icon="💬")

st.title("💬 Shiza — Shizaye Multilinks Support Agent")
...
if user_input:
    ...
    with st.chat_message("assistant"):
        with st.spinner("Shiza is thinking..."):
...
# --- Sidebar ---
with st.sidebar:
    st.header("About Shiza")
    st.write(
        "Shiza is an AI support agent for Shizaye Multilinks, built with Llama 3.3 "
